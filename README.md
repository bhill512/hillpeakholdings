...
## Optional: Add the one-page buyer profile PDF

The page links to `./buyer-profile.pdf`. To enable it:

- Add your PDF file to the project root named `buyer-profile.pdf`
